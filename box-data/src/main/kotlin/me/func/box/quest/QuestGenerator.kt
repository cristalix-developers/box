...
object QuestGenerator {
    ...
    private val easyQuests: List<BattlePassQuest> = listOf(
        ...
        BattlePassQuest("Устраните противников в режиме 4x4 Lucky",  ServerType.BOXLUCKY, QuestType.KILL, 2),
        ...
        BattlePassQuest("Одержите победу в режиме 4x4 Lucky", ServerType.BOXLUCKY, QuestType.WIN, 1),
        ...
        BattlePassQuest("Сыграйте в режиме 4x4 Lucky", ServerType.BOXLUCKY, QuestType.PLAY, 2),
        ...
        BattlePassQuest("Сломайте кровать противнику в режиме 4x4 Lucky", ServerType.BOXLUCKY, QuestType.BEDBREAK, 1),
        ...
        BattlePassQuest("Совершите покупку в режиме 4x4 Lucky", ServerType.BOXLUCKY, QuestType.BUYITEMS, 10),
        ...
        BattlePassQuest("Сломайте блоки в режиме 4x4 Lucky", ServerType.BOXLUCKY, QuestType.BLOCKBREAK, 70),
    ...
    private val rareQuests: List<BattlePassQuest> = listOf(
        ...
        BattlePassQuest("Устраните противников в режиме 4x4 Lucky", ServerType.BOXLUCKY, QuestType.KILL, 2 * 4),
        ...
        BattlePassQuest("Одержите победу в режиме 4x4 Lucky", ServerType.BOXLUCKY, QuestType.WIN, 1 * 4),
        ...
        BattlePassQuest("Сыграйте в режиме 4x4 Lucky", ServerType.BOXLUCKY, QuestType.PLAY, 2 * 4),
        ...
        BattlePassQuest("Сломайте кровать противнику в режиме 4x4 Lucky", ServerType.BOXLUCKY, QuestType.BEDBREAK, 1 * 4),
        ...
        BattlePassQuest("Совершите покупку в режиме 4x4 Lucky", ServerType.BOXLUCKY, QuestType.BUYITEMS, 10 * 4),
        ...
        BattlePassQuest("Сломайте блоки в режиме 4x4 Lucky", ServerType.BOXLUCKY, QuestType.BLOCKBREAK, 70 * 4),
    ...
    private val specialQuests: List<BattlePassQuest> = listOf(
        ...
        BattlePassQuest("Устраните противников в режиме 4x4 Lucky", ServerType.BOXLUCKY, QuestType.KILL, 2 * 9),
        ...
        BattlePassQuest("Одержите победу в режиме 4x4 Lucky", ServerType.BOXLUCKY, QuestType.WIN, 1 * 9),
        ...
        BattlePassQuest("Сыграйте в режиме 4x4 Lucky", ServerType.BOXLUCKY, QuestType.PLAY, 2 * 9),
        ...
        BattlePassQuest("Сломайте кровать противнику в режиме 4x4 Lucky", ServerType.BOXLUCKY, QuestType.BEDBREAK,  1 * 9),
        ...
        BattlePassQuest("Совершите покупку в режиме 4x4 Lucky", ServerType.BOXLUCKY, QuestType.BUYITEMS, 10 * 9),
        ...
        BattlePassQuest("Сломайте блоки в режиме 4x4 Lucky", ServerType.BOXLUCKY, QuestType.BLOCKBREAK,  70 * 9),
